...
namespace Pair_Programming
{
    public class Program
    {
        ...
        private string CheckIfLetter(string userInput)
        {
            while (!userInput.All(Char.IsLetter))
            {
